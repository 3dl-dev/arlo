...
ground-truth or operator ceiling. (For arlo this is STEP 3; `grade/PROTOCOL.md` is the
agent-driven grader this loop drives.)
...
*this* file for the trap it failed to prevent. arlo is meta's meta; so is its optimizer.
